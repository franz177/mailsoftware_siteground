...
<div class="subheader py-2 {{ Metronic::printClasses('subheader', true) }}" id="kt_subheader">
    <div class="{{ Metronic::printClasses('subheader-container', true) }} d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
