...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var oTable3 = table_22.DataTable({
                ...
                ajax: {
                    url:"{{ route('costi_annuale_mesi.data') }}",
                    data: function (d) {
                        d.year = 2022;
                        d.house = $('#house').val();
                    }
            ...
            var oTable2 = table_21.DataTable({
                // Internationalisation. For more info refer to http://datatables.net/manual/i18n
                "language": {
                    "aria": {
                        "sortAscending": ": attivare per ordinare la colonna in ordine crescente",
            ...
            var oTable1 = table_20.DataTable({
                // Internationalisation. For more info refer to http://datatables.net/manual/i18n
                "language": {
                    "aria": {
                        "sortAscending": ": attivare per ordinare la colonna in ordine crescente",
