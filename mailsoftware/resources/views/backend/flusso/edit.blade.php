...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-xxl-12">
            <form action="/backend/modello/{{ $type->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="/backend/modello/{{ $type->id }}" class="btn btn-light-danger btn-sm font-weight-bolder font-size-sm py-3 px-6">Annulla</a>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="mb-8 d-flex flex-column">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="{{ $type->name }}" id="name" name="name">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 col-md-2">
                                    <div class="mb-8 d-flex flex-column">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" value="{{ $type->sorting }}" id="sorting" name="sorting">
                                        </div>
                                    </div>
                                </div>
