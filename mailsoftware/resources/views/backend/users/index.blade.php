            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        ...
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Totale {{ count($users) }} Priorità</span>
                    </h3>
                    <div class="card-toolbar">
                        <a href="javascript:void(0)" class="btn btn-danger btn-sm font-weight-bolder font-size-sm py-3 px-6" id="createNewCity" name="createNewCity">Aggiungi <img src="{{ asset('/media/svg/icons/Navigation/Plus.svg') }}"/></a>
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('click', '.editCity', function () {
                ...
                $.get("{{ route('users.index') }}" +'/' + city_id +'/edit', function (data) {
