...
class BookingInsertUpdateJob implements ShouldQueue
{
                ...
                try {
                    ...
                    Booking::updateOrCreate(
                        ...
                        [
                            ...
                            'tx_mask_t5_kross_payment_total_amount' => $booking['tx_mask_t5_kross_payment_total_amount'], 'tx_mask_t5_kross_payments' => $booking['tx_mask_t5_kross_payments'],
                            'tx_mask_t6_assistenza_interventol_lastminute' => $booking['tx_mask_t6_assistenza_interventol_lastminute'], 'tx_mask_t6_intervento_lastminute' => $booking['tx_mask_t6_intervento_lastminute'],
                            'costo_orario' => 0,
                            'totale_pulizie' => 0,
                            'costo_co' => 0,
                            'mancia_cli' => 0,
