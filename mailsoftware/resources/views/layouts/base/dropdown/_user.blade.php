...
<div class="navi navi-spacer-x-0 pt-5">
    {{-- Item --}}
    @if(Auth::user()->role === 1)
        <a href="/backend" class="navi-item px-8">
            <div class="navi-link">
                ...
                <div class="navi-text">
                    <div class="font-weight-bold">Backoffice</div>
                    <div class="text-muted">Impostazioni Case, Testi ...</div>
                </div>
            </div>
        </a>
        <a href="{{ route('register') }}" class="navi-item px-8">
            <div class="navi-link">
                <div class="symbol symbol-40 bg-light mr-3">
                    <div class="symbol-label">
                        <span class="svg-icon svg-icon-md svg-icon-success">
                ...
                <div class="navi-text">
                    <div class="font-weight-bold">Aggiungi Account</div>
                    <div class="text-muted">Crea nuovi account...</div>
                </div>
            </div>
        </a>
    @endif
    ...
    <div class="navi-footer  px-8 py-5">
        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn btn-light-primary font-weight-bold">{{ __('Logout') }}</a>
