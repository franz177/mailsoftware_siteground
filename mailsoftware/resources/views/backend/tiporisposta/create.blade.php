...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-xxl-12">
            <form action="/backend/tiporisposta" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-header border-0 py-5">
                        ...
                        <div class="card-toolbar">
                            ...
                            <a href="/backend/tiporisposta" class="btn btn-light-danger btn-sm font-weight-bolder font-size-sm py-3 px-6">Annulla</a>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-12 col-md-2">
                                    <div class="mb-8 d-flex flex-column">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="number" value="" id="sorting" name="sorting" placeholder="Partire dal numero {{ $typeanswer_count+1 }}">
                                        </div>
                                    </div>
                                </div>
